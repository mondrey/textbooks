...
When we talk about a certain number of square meters, say 7 of them, we can write it as “7 square meters” or “7 `"m"^2`”. In fact, the “`"m"^2`’ is read as “meters squared.” Any power of “2” is often read as “squared.” For example,  we can read92 as “9 squared” because we would need to multiply 9 x 9 when finding the [[area | perimeter]] of a square with side length 9. 
...
Below is a square meter and a bin of squares that are ½ meter on each side. See how many `1/2` square meters you need to fill in the square meter:
